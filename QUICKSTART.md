...
├── 🎓 exercises/             ← 6 hands-on tutorials
│   ├── 01-basic-setup.md
│   ├── 02-custom-fields.md
│   ├── 03-automation.md
│   ├── 04-multiple-views.md
│   ├── 05-roadmap.md
...
│   └── learning-path.md     ← Study roadmap
...
1. **Learn by Doing** 🛠️
   ...
   - Don't just read, create real project
   - Use for actual work
...
- [Exercise 1](exercises/01-basic-setup.md) - Basics
- [Cheat Sheet](docs/cheat-sheet.md) - Quick ref

**Nice to Read (30 min):**

- [Learning Path](docs/learning-path.md) - Study guide
...
- Check [Cheat Sheet](docs/cheat-sheet.md)
...
5. Become project management pro!

---

**Let's get started! Go to [Exercise 1](exercises/01-basic-setup.md) →**

---

## 🌟 Star This Repo!

Jika repository ini helpful, jangan lupa:
